<template>
  <div style="overflow: hidden;">
    <div class="row">
      <div class="col-md-12">
          <h2 style="text-decoration: underline;">{{ $t('about.about') }}</h2>
      </div>
    </div>
    ...
    <b-row class="mt-6">
      <b-col offset="9">
         <b-btn variant="primary rounded-pill" class="new-post-btn mt-5" @click="submitContact">
          <span class="fas fa-plus-circle"></span> {{ $t('about.save about')}}
         </b-btn>
      </b-col>
    </b-row>
  </div>
